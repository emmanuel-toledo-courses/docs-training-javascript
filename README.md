...
Generar un objeto que contenga las propiedades (generales / básicas) de un proyecto, una de las propiedades debe de ser de tipo arreglo, para almacenar las actividades del mismo.
